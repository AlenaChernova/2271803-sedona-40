...
* Студент: [Алена Чернова](https://up.htmlacademy.ru/htmlcss/40/user/2271803).
* Наставник: `Кексобот`.
* Сайт: [Мой проект Седона] (https://alenachernova.github.io/2271803-sedona-40/).
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/2271803-sedona-40) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
